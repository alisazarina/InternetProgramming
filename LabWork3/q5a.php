...
<form method="post" action="q5a.php"> 
...
<input type="radio" name="tv" value="TV114">TV114<br> <input type="radio" name="tv" value="TVot">Others<br>  
<input  type="submit" name="btn_submit" value="Choose"> <br> 
</form> 
 <?php 
