<?php # Script 3.5 - calculator-sticky.php
...
<form action="calculator-sticky.php" method="post"> 
    ...
    echo $_POST['tax']; ?>" /></p>
 	...
 	<p><input type="submit" name="submit" value="Calculate!" /></p>  	<input type="hidden" name="submitted" value="TRUE" /> 
</form> <?php 
